...
//criando um logger (org.slf4j.Logger)	
	...
	public UserDTO insert(UserInsertDTO dto) {
		...
		//criptografando antes de salvar usando o encoder das config do app.
...
//implementando os Details do token de autorização
	@Override
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		//usando o find criado no repositorio.
